...
const DetherZoning = artifacts.require('./map/DetherZoning.sol');
...
module.exports = async (callback) => {
  ...
  const detherZoning = await DetherZoning.deployed();
  console.log('address DetherZoning => ', detherZoning.address);
  ...
  // [DetherCore] init
  //
  await detherCore.initContract(detherToken.address, detherBank.address, detherZoning.address);
  ...
  console.log('zoning should be => ', detherZoning.address, await detherCore.zoning.call());
  ...
  //
  await detherCore.setLicenceTellerPrice(web3.toHex('CG'), web3.toWei('1'));
  console.log('licenceteller should be => ', '10', web3.fromWei(await detherCore.licenceTeller.call(web3.toHex('CG'))));
  ...
  await detherCore.setSellDailyLimit(1, web3.toHex('CG'), 1000);
  console.log('getSellDailyLimit tier1 CG should be => ', '1000', (await detherCore.getSellDailyLimit(1, web3.toHex('CG'))));
  await detherCore.setSellDailyLimit(2, web3.toHex('CG'), 5000);
  console.log('getSellDailyLimit tier2 CG should be => ', '5000', (await detherCore.getSellDailyLimit(2, web3.toHex('CG'))));
  ...
  await detherCore.openZoneTeller(web3.toHex('CG'));
  console.log('zone CG for teller should be open', await detherCore.openedCountryTeller.call(web3.toHex('CG')));
